...
<?php if( has_post_thumbnail()) : ?>
	<section class="sections-bg-alt parallax-layer no-margin-bottom padding-bottom-100 background" style="background: linear-gradient(rgba(78, 78, 78, 0.75), rgba(78, 78, 78, 0.75)), url( <?php echo $image_url; ?> ) no-repeat fixed; background-size: cover" data-stellar-background-ratio="0.5">
<?php else: ?>
